...
export const metadata: Metadata = seoPages["/tv-schadetaxatie-nijmegen"]

export default function NijmegenPage() {
  const schema = generateBreadcrumbSchema([
    { name: "Home", url: "https://tvschaderapport.nl" },
    { name: "TV Schadetaxatie Nijmegen", url: "https://tvschaderapport.nl/tv-schadetaxatie-nijmegen" },
  ])
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <BreadcrumbNav crumbs={[{ name: "Home", href: "/" }, { name: "TV Schadetaxatie Nijmegen" }]} />
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">
          TV Schadetaxatie Nijmegen — Schaderapport binnen 24 uur
        </h1>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Bewoners van Nijmegen kunnen voor een TV schadetaxatie volledig online terecht bij
          tvschaderapport.nl. Of uw televisie nu beschadigd is in Centrum, Dukenburg, Lindenholt en Waalsprong —
          ons schaderapport is snel en eenvoudig aan te vragen.
        </p>
        <p className="text-gray-700 leading-relaxed mb-6">
          Nijmegen is de oudste stad van Nederland. Ons schaderapport wordt overal geaccepteerd, ook bij lokale verzekeringsadviseurs in Nijmegen.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          Vul het formulier in, upload minimaal 2 foto&apos;s van uw beschadigde televisie en betaal veilig
          via iDEAL. Uw TV schadetaxatie in Nijmegen leidt binnen 24 uur tot een officieel PDF-rapport
      ...
      <CTASection title="TV Schadetaxatie Nijmegen — Rapport binnen 24 uur" />
    </>
  )
}
