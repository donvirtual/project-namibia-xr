...
export const metadata: Metadata = seoPages["/tv-schadetaxatie-almere"]

export default function AlmerePage() {
  const schema = generateBreadcrumbSchema([
    { name: "Home", url: "https://tvschaderapport.nl" },
    { name: "TV Schadetaxatie Almere", url: "https://tvschaderapport.nl/tv-schadetaxatie-almere" },
  ])
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <BreadcrumbNav crumbs={[{ name: "Home", href: "/" }, { name: "TV Schadetaxatie Almere" }]} />
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">
          TV Schadetaxatie Almere — Schaderapport binnen 24 uur
        </h1>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Bewoners van Almere kunnen voor een TV schadetaxatie volledig online terecht bij
          tvschaderapport.nl. Of uw televisie nu beschadigd is in Almere-Stad, Almere-Haven, Almere-Buiten en Almere-Poort —
          ons schaderapport is snel en eenvoudig aan te vragen.
        </p>
        <p className="text-gray-700 leading-relaxed mb-6">
          Almere is een van de snelst groeiende steden van Nederland. Onze online dienst is ideaal voor drukke Almeerders.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          Vul het formulier in, upload minimaal 2 foto&apos;s van uw beschadigde televisie en betaal veilig
          via iDEAL. Uw TV schadetaxatie in Almere leidt binnen 24 uur tot een officieel PDF-rapport
      ...
      <CTASection title="TV Schadetaxatie Almere — Rapport binnen 24 uur" />
    </>
  )
}
