...
export const metadata: Metadata = seoPages["/tv-schadetaxatie-breda"]

export default function BredaPage() {
  const schema = generateBreadcrumbSchema([
    { name: "Home", url: "https://tvschaderapport.nl" },
    { name: "TV Schadetaxatie Breda", url: "https://tvschaderapport.nl/tv-schadetaxatie-breda" },
  ])
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <BreadcrumbNav crumbs={[{ name: "Home", href: "/" }, { name: "TV Schadetaxatie Breda" }]} />
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">
          TV Schadetaxatie Breda — Schaderapport binnen 24 uur
        </h1>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Bewoners van Breda kunnen voor een TV schadetaxatie volledig online terecht bij
          tvschaderapport.nl. Of uw televisie nu beschadigd is in Centrum, Bavel, Prinsenbeek en Teteringen —
          ons schaderapport is snel en eenvoudig aan te vragen.
        </p>
        <p className="text-gray-700 leading-relaxed mb-6">
          Bredase bewoners kunnen via onze online dienst een officieel TV schaderapport laten opstellen, volledig op afstand.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          Vul het formulier in, upload minimaal 2 foto&apos;s van uw beschadigde televisie en betaal veilig
          via iDEAL. Uw TV schadetaxatie in Breda leidt binnen 24 uur tot een officieel PDF-rapport
      ...
      <CTASection title="TV Schadetaxatie Breda — Rapport binnen 24 uur" />
    </>
  )
}
