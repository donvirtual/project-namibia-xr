...
export const metadata: Metadata = seoPages["/tv-schadetaxatie-tilburg"]

export default function TilburgPage() {
  const schema = generateBreadcrumbSchema([
    { name: "Home", url: "https://tvschaderapport.nl" },
    { name: "TV Schadetaxatie Tilburg", url: "https://tvschaderapport.nl/tv-schadetaxatie-tilburg" },
  ])
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <BreadcrumbNav crumbs={[{ name: "Home", href: "/" }, { name: "TV Schadetaxatie Tilburg" }]} />
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">
          TV Schadetaxatie Tilburg — Schaderapport binnen 24 uur
        </h1>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Bewoners van Tilburg kunnen voor een TV schadetaxatie volledig online terecht bij
          tvschaderapport.nl. Of uw televisie nu beschadigd is in Centrum, Oud-Noord, Reeshof en Berkel-Enschot —
          ons schaderapport is snel en eenvoudig aan te vragen.
        </p>
        <p className="text-gray-700 leading-relaxed mb-6">
          In Tilburg kunt u snel en eenvoudig een officieel TV schaderapport aanvragen, zonder dat een taxateur bij u langskomt.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          Vul het formulier in, upload minimaal 2 foto&apos;s van uw beschadigde televisie en betaal veilig
          via iDEAL. Uw TV schadetaxatie in Tilburg leidt binnen 24 uur tot een officieel PDF-rapport
      ...
      <CTASection title="TV Schadetaxatie Tilburg — Rapport binnen 24 uur" />
    </>
  )
}
