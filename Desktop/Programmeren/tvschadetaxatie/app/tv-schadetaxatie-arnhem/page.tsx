...
export const metadata: Metadata = seoPages["/tv-schadetaxatie-arnhem"]

export default function ArnhemPage() {
  const schema = generateBreadcrumbSchema([
    { name: "Home", url: "https://tvschaderapport.nl" },
    { name: "TV Schadetaxatie Arnhem", url: "https://tvschaderapport.nl/tv-schadetaxatie-arnhem" },
  ])
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <BreadcrumbNav crumbs={[{ name: "Home", href: "/" }, { name: "TV Schadetaxatie Arnhem" }]} />
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">
          TV Schadetaxatie Arnhem — Schaderapport binnen 24 uur
        </h1>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Bewoners van Arnhem kunnen voor een TV schadetaxatie volledig online terecht bij
          tvschaderapport.nl. Of uw televisie nu beschadigd is in Centrum, Presikhaaf, Kronenburg en Elderveld —
          ons schaderapport is snel en eenvoudig aan te vragen.
        </p>
        <p className="text-gray-700 leading-relaxed mb-6">
          Arnhemse bewoners kunnen via ons online formulier een TV schaderapport aanvragen dat direct bruikbaar is voor hun verzekeraar.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          Vul het formulier in, upload minimaal 2 foto&apos;s van uw beschadigde televisie en betaal veilig
          via iDEAL. Uw TV schadetaxatie in Arnhem leidt binnen 24 uur tot een officieel PDF-rapport
      ...
      <CTASection title="TV Schadetaxatie Arnhem — Rapport binnen 24 uur" />
    </>
  )
}
